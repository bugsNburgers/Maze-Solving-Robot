...
def main():
    ...
    initial_pose.pose.orientation.z = sin(0.2 / 2.0)
    initial_pose.pose.orientation.w = cos(0.2 / 2.0)
    ...
    goal_pose.pose.orientation.z = sin(0.2 / 2.0)
    goal_pose.pose.orientation.w = cos(0.2 / 2.0)
